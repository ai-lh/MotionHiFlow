...
from src.visualization.InverseKinematics import BasicInverseKinematics, BasicJacobianIK, InverseKinematics
from src.visualization.Quaternions import Quaternions
import src.visualization.BVH_mod as BVH
from src.visualization.remove_fs import *

from src.utils.plot_script import plot_3d_motion
from src.utils import paramUtil
from .common.skeleton import Skeleton
import torch

from torch import nn
from src.visualization.utils.quat import ik_rot, between, fk, ik
...
class Joint2BVHConvertor:
    def __init__(self):
        self.template = BVH.load('./src/visualization/data/template.bvh', need_quater=True)
